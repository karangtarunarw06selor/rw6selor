...
try {
    ...
    // Ambil player dari room yang sama
    ...
    // Player pertama berdasarkan turn_order jadi starter
    $firstPlayerId = (int)$players[0]["player_id"];

    // Opsional: tandai room tetap aktif/playing
    ...
    echo json_encode([
        "success" => true,
        "message" => "Rematch created in same room",
        "room_code" => $roomCode,
        "room_id" => $roomId,
        "match_id" => $newMatchId
    ]);
